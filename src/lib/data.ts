...
export const kpis: KPI[] = [
  {
    ...
    description: "Total number of new leads from the activity.",
  },
  {
    id: "KPI02",
    name: "Sales Pipeline (USD)",
    description: "Value of sales opportunities created.",
  },
  {
    id: "KPI03",
    name: "Brand Mentions",
    description: "Number of social media and press mentions.",
  },
];
...
export const countryApprovers: CountryApprover[] = [
  {
    ...
    approverEmail: "david.lee@example.com",
  },
  {
    id: "CA02",
    country: "UK",
    approverName: "Sophia Green",
    approverEmail: "sophia.green@example.com",
  },
  {
    id: "CA03",
    country: "Germany",
    approverName: "Klaus Mueller",
    approverEmail: "klaus.mueller@example.com",
  },
];
...
export const attachments: Attachment[] = [
  {
    id: "ATT01",
    activityId: "ACT-001",
    fileName: "Quote_Cisco_Webinar.pdf",
    url: "#",
    uploadedBy: "John Doe",
...
export const comments: Comment[] = [
  {
    id: "CMT01",
    activityId: "ACT-001",
    text: "Waiting for final approval from marketing director.",
    author: "John Doe",
  ...
  },
  {
    id: "CMT02",
    activityId: "ACT-001",
    text: "Approved. Please proceed with PO.",
    author: "Jane Smith",
  ...
  },
  {
    id: "CMT03",
    activityId: "ACT-002",
    text: "Can we increase the budget for catering?",
    author: "John Doe",
